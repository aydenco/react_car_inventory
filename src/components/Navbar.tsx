...
function Navbar() {
  ...
  return (
    <nav className='flex item-center justify-between flex-wrap bg-teal-500 p-6'>
        ...
        <div className='w-full block flex-grow items-center'>
            <div className="text-sm lg:flex-grow">
                ...
                <Button className='p-3 m-5 bg-teal-400 justify-center'>
                    <div>
                        <Link to='/vehicle' onClick={ clicked } className='flex place-items-center mt-4 lg:inline-block lg:mt-0
                        text-teal-200 hover:text-white mr-4'>
                            Vehicle
                        </Link>
                    </div>
